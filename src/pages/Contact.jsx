export default function Contact() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 via-white to-orange-200 flex items-center justify-center py-16 px-5"
    style={{backgroundImage: "url('https://img.freepik.com/premium-photo/flat-style-vector-art-featuring-painter-dark-colors_1141064-24224.jpg?w=2000')"}}
    >
